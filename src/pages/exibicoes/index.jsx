...
const CinemaItinerante = () => {
  return (
    <Stack p={3}  justify="space-around" spacing={6} w="100%">
      ...
      <Text px="15%" className="justify">Para este ano, as exibições dos filmes irão acontecer em um formato itinerante com o CINEMA DE RUA. Iremos levar nosso cinema para diferentes cantos da cidade do Rio Grande. Nossa primeira exibição será no Rincão da Cebola, no Centro da cidade, depois iremos levar nosso cinema até a Orla da Henrique Pancada, seguindo para a Ilha dos Marinheiros e logo para o Taim, encerrando nosso evento no Cassino. Cada exibição irá acontecer em um dia da semana, de segunda a sexta, às 19h. Acompanhe pelo mapa onde será cada exibição para saber qual lugar fica mais próximo de você.</Text>
