...
const Footer = () => {
  return (
    <Stack className="footer" spacing={5} bgColor="brand.azul" position="relative" bottom={0} align="center" py={4} px={2} w="100%">
      <Stack align="center">
        <Text textTransform="lowercase" color="brand.rosa" fontWeight='bold'>idealização</Text>
        <Image src={Ofcine.src} h={{base:"30px", md: "40px"}} alt="Logotipo ofcine" />
      </Stack>

      <Stack align="center" w="100%">
        <Text textTransform="lowercase" color="brand.rosa" fontWeight='bold'>realização</Text>
      ...
      <Stack align="center" w="100%">
        <Text textTransform="lowercase" color="brand.rosa" fontWeight='bold'>apoio</Text>
        <Stack spacing={3} w="100%">
          <Stack direction="row" wrap="wrap" spacing={{base: 6, md: 28}} justify="center"  w="100%">
            <Image src={Marte.src} h={{base: "30px", md: "50px"}} alt="Logotipo Marte" />
            <Image src={Furg.src} h={{base: "30px", md: "50px"}} alt="Logotipo Furg" />
            <Image src={Ila.src} h={{base: "15px", md: "25px"}} alt="Logotipo Ila" />
            <Image src={Ufpel.src} h={{base: "30px", md: "50px"}} alt="Logotipo Ufpel" />
            <Flex direction='column'>
              <Image src={CinemaUfpel.src} h={{base: "15px", md: "25px"}} alt="Logotipo Ila" mb={2} />
              <Image src={MestradoUfpel.src} h={{base: "15px", md: "25px"}} alt="Logotipo Ufpel" />
            </Flex>
          </Stack>
          <Stack direction="row" wrap="wrap" spacing={{base: 6, md: 28}} justify="center"  w="100%">
            <Image src={Fapergs.src} h={{base:"25px", md: "35px"}} alt="Logotipo Fapergs" />
            <Image src={Cnpq.src} h={{base: "20px", md: "30px"}} alt="Logotipo CNPQ" />
            <Image src={IfsulSL.src} h={{base: "20px", md: "30px"}} alt="Logotipo IfSul campus Santana do Livramento" />
            <Image src={PortoRs.src} h={{base: "20px", md: "30px"}} alt="Logotipo Autoridade portuária do RS" />
          </Stack>
          <Flex wrap="wrap" justify="space-around" align="center"  w="100%">
            <Image src={Ministerio.src} h={{base: "25px", md: "40px"}} alt="Logotipo Ministério publico" />
          </Flex>
        </Stack>
      </Stack>
    </Stack>
